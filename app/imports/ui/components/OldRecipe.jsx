...
class OldRecipe extends React.Component {
  render() {
    return (
        <Container>
          <Header textAlign='center' size='large'>The Perfect Cheese Omelette</Header> <br/>
          <Segment raised><b>Cook Time:</b> 5 Minutes <b>Ratings (43):</b> <Icon size='small' name='star'/><Icon
          ...
          <Grid>
            ...
            <GridColumn width={12}>
              ...
              <List ordered>
                ...
                <List.Item> Pour in the egg mixture tilting the pan to spread it evenly. Let the egg firm up a little,
                  and
                  after about ten-seconds shake the pan a bit and use a spatula to gently direct the mixture away from
                  the
                  sides and into the middle. Allow the remaining liquid to then flow into the space left at the sides of
                  the pan.</List.Item>
                <List.Item>Continue to cook for another minute or so until the egg mixture holds together. Do not let
                  the
